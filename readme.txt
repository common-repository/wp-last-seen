...
Donate link: http://plainsight.ro/
Tags: last seen, user tracker, last time seen, member tracking, user last seen
...
1. Widget on front page (can be placed anywhere your theme allows)
...
= 1.0.1 =
* Small bugfix on displaying multiple users
